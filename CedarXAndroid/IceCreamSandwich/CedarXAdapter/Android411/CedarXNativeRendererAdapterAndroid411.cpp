...
*               All Rights Reserved
*
* File   : CedarXNativeRendererAdapterAndroid411.cpp
* Version: V1.0
* By     : 
* Date   : 2012-9-18
* Description:
...
#define LOG_TAG "CedarXNativeRendererAdapterAndroid411"
...
static int convertVirtualVideo3DInfo2video3Dinfo_t(video3Dinfo_t *pDes, VirtualVideo3DInfo *pSrc)
{
	...
	pDes->src_mode = MapHWC3DSrcMode_Virtual2Arch(pSrc->src_mode);
...
int CedarXNativeRendererAdapter::CedarXNativeRendererAdapterIoCtrl(int cmd, int para, void *pbuffer)
{
    ...
    switch(cmd)
    {
    	...
    	case VIDEORENDER_CMD_SETSCREEN       :  //no use
            return pCedarXNativeRenderer->mNativeWindow->perform(pCedarXNativeRenderer->mNativeWindow.get(), NATIVE_WINDOW_SETPARAMETER, HWC_LAYER_SETMODE, para);
